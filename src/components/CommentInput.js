...
// import { myUser1CommentList, myCommentUpdate } from './recoil';
...
//         // 1번 댓글 
//         const [user1CommenList, setUser1CommenList] = useRecoilState(myUser1CommentList);
//         // 작성한 댓글
...
//             setCommentUpdate({
//               ...CommentUpdate,
//               [postId]: [...(CommentUpdate[postId] || []), { text: user1CommenList, id: 'currentUser' }],
//             });
